                        ...
                        <div class="auth-content">
                            ...
                            <div class="auth-form-section">
                                <div class="auth-header">
                                    <h2><i class="fa fa-truck"></i> REGISTRAR PROVEEDOR</h2>
                                </div>
                                
                                <form role="form" method="post" class="auth-form" id="formularioProveedor">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="nuevoProveedor">
                                    ...
                                    <div class="auth-actions">
                                        ...
                                        <a href="proveedor" class="btn btn-secondary">
                            ...
                            <div class="auth-photo-section">
                                <div class="photo-upload-container">
                                    <div class="preview-container">
                                        <img src="vistas/img/plantilla/p.webp" class="preview-image" alt="Vista previa">
                                    </div>
                                </div>
                            </div>
                        </div>
