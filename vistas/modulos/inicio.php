<div class="content-wrapper text-uppercase">
  ...
  <section class="content">
    ...
    <?php if (!Permisos::tiene("reportes.ventas") && !Permisos::tiene("reportes.ganancias")) { ?>
    ...
    <div class="row">
      <?php if (Permisos::tiene("reportes.ventas") || Permisos::tiene("reportes.ganancias")) { include "inicio/cajas-superiores.php"; } ?>
    </div> 
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <?php if (Permisos::tiene("reportes.top_productos")) { include "reportes/productos-mas-vendidos.php"; } ?>
      </div>

      <div class="col-lg-6">
        <?php if (Permisos::tiene("reportes.ventas")) { include "inicio/productos-recientes.php"; } ?>
      </div>
    </div>
  </section>
</div>
