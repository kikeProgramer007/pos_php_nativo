...
class imprimirFacturaComanda
{
    ...
    private function generarTablaProductos($productos, $total, $totalPagado, $cambio, $notaGeneral = '', $esComanda = false, $totalBrutoVenta = null, $totalDescuentoVenta = null) {
        ...
        if (!$esComanda) {
            $html .= '<p style="font-size: 9px; text-align: center;">¡GRACIAS POR SU COMPRA!<br>PEDIDOS AL 72661611<br><span style="font-size: 7px; margin-top: 2px;">Sistemas: 73982982</span></p>';
        }
